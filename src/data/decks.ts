...
export const dragapultDeck: DeckPreset = {
  ...
  pokemon: [
    ...
    { name: 'Dragapult ex', stage: 'stage2', hp: 320, type: 'dragon', evolvesFrom: 'Drakloak', attacks: [{ name: 'Jet Headbutt', cost: ['normal'], damage: '70', description: '' }, { name: 'Phantom Dive', cost: ['fire', 'psychic'], damage: '200', description: 'Put 6 damage counters on your opponent\'s Benched Pokémon in any way you like.' }], retreatCost: 1, rarity: 'ultra' },
